									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												...
												{!! Form::open(['route' => 'postChangePassword', 'method' => 'post', 'id' => 'postChangePassword', 'name' => 'postChangePassword', 'class' => 'form-validate', 'novalidate' => 'novalidate']) !!}
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																{!! Form::select('usuario', $usuarios, null, ['id' => 'usuario', 'class' => 'span12', 'required' => true]) !!}
															</span>
														</label>
														<label>
															<span class="block input-icon input-icon-right">
																{!! Form::text('pregunta', null, ['placeholder' => 'Pregunta secreta', 'class' => 'span12', 'id' => 'pregunta', 'required' => true, 'readOnly' => true]) !!}
																<i class="icon-question"></i>
															</span>
														</label>
														<label>
															<span class="block input-icon input-icon-right">
																{!! Form::text('respuesta', null, ['placeholder' => 'Respuesta secreta', 'class' => 'span12', 'id' => 'respuesta', 'required' => true]) !!}
																<i class="icon-edit"></i>
															</span>
														</label>
														<div class="space"></div>
														<div class="clearfix">
															{!! Form::button('Comprobar', ['class'=> 'width-35 pull-right btn btn-small btn-primary', 'id' => 'loginButton', 'type' => 'submit']) !!}
														</div>
